    ...
    <div className='w-full min-h-screen pb-10 lg:pt-[94px] flex flex-col justify-center sm:items-center'>
      <div className='w-full py-36 lg:py-40 flex flex-col-reverse lg:flex-row justify-evenly items-center'>
        <motion.div
          ...
          className='w-[90%] lg:w-[600px] flex flex-col gap-y-4 items-start md:items-center lg:items-start'
        >
          ...
          <div className='flex gap-x-3 sm:gap-x-5'>
            <ContactSocialBox
              icon={
                <FaDiscord className='text-[1.65rem] sm:text-[1.85rem] text-neon' />
              }
            />
            <ContactSocialBox
              icon={
                <FaLinkedin className='text-[1.65rem] sm:text-[1.85rem] text-neon' />
              }
            />
            <ContactSocialBox
              icon={
                <FaInstagram className='text-[1.65rem] sm:text-[1.85rem] text-neon' />
              }
            />
            <ContactSocialBox
              icon={
                <FaTwitter className='text-[1.65rem] sm:text-[1.85rem] text-neon' />
              }
            />
            <ContactSocialBox
              icon={
                <FaReddit className='text-[1.65rem] sm:text-[1.85rem] text-neon' />
              }
            />
          </div>
        </motion.div>
