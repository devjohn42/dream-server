  ...
  return (
    ...
    >
      ...
      <div className="w-[90%] flex gap-x-4 items-center justify-between">
        <h6 className="text-rich dark:text-alice font-semibold">Ongoing Support</h6>
      ...
      <div className="w-[90%] flex flex-col gap-y-1 items-center">
        <div className="w-full bg-alice dark:bg-jet p-[0.25rem] rounded flex gap-x-5 items-center justify-between">
          <p className="text-rich dark:text-alice font-semibold">Initial Setup </p>
          <p className="text-rich dark:text-alice font-semibold">${initialSetup}</p>
        </div>
        <div className="w-full bg-alice dark:bg-jet p-[0.25rem] rounded flex gap-x-5 items-center justify-between">
          <p className="text-rich dark:text-alice font-semibold">Themed Customizations</p>
          <p className="text-rich dark:text-alice font-semibold">${themedCustom}</p>
        </div>
        <div className="w-full bg-alice dark:bg-jet p-[0.25rem] rounded flex gap-x-5 items-center justify-between">
          <p className="text-rich dark:text-alice font-semibold">Bot Integration - {botCount}</p>
          <p className="text-rich dark:text-alice font-semibold">${botIntegration}</p>
        </div>
        <div className="w-full bg-alice dark:bg-jet p-[0.25rem] rounded flex gap-x-5 items-center justify-between">
          <p className="text-rich dark:text-alice font-semibold">Sector-Specific Tools</p>
          <p className="text-rich dark:text-alice font-semibold">${sectorTools}</p>
        </div>
      </div>
